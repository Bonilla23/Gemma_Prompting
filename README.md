...
| Con reintento? | Total Pruebas | Válidos | Fallidos | Precisión | Errores encontrados                                                   |
| :------------- | :------------ | :------ | :------- | :-------- | :-------------------------------------------------------------------- |
| No             | 10            | 6       | 4        | 60.0%     | json_parse_error, missing_field                                       |
| **Sí**         | 10            | 8       | 2        | **80.0%** | Contenido no permitido y la entrada debe contener información valida. |